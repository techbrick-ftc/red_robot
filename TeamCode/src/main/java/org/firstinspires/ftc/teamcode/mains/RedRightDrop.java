...
@Autonomous(name="Red Right Drop", group="Red")
public class RedRightDrop extends LinearOpMode implements TeleAuto {
    ...
    public void runOpMode() {
        ...
        //openCV.setFieldBox(0, 140, 50, 50);
        openCV.setDifferences(136, 151);
